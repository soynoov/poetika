...
const challengeIconsByCategory: Record<string, ChallengeIcon> = {
	...
	animal: {
		label: 'fish',
		path: 'M4 12c2.2-2.6 4.8-4 7.7-4 .9 0 1.9.14 2.8.42l2.7-1.92-.48 3.15c1.62 1 2.7 2.46 3.2 4.35-.98-.45-1.98-.67-3-.67-.5 0-.98.05-1.44.15-.72 2.97-2.96 4.52-6.33 4.52C7.9 18 5.74 17.02 4 15c1.6.08 3.06-.18 4.39-.79-1.46-.5-2.59-1.24-3.39-2.21ZM15.25 11.1a.65.65 0 1 0 0-1.3.65.65 0 0 0 0 1.3Z',
	},
};
