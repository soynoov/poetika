...
const challengeIconsByCategory: Record<string, ChallengeIcon> = {
	...
	animal: {
		label: 'bird',
		path: 'M3.5 12.5c2.7-2.8 5.4-4.2 8-4.2 1.7 0 3.2.5 4.4 1.6l2.6-.4-1.4 2.1c.3.6.4 1.2.4 1.9 0 3.6-2.9 6-6.8 6-2.6 0-4.7-1-6.7-3 2.1.2 3.8-.2 5.3-1.2-1.7-.2-3-1-3.9-2.4 1.1.1 2-.1 2.8-.6-1.4-.7-2.3-1.8-2.7-3.8Z',
	},
};
